...
public class PredicatedCollectionBuilderTest {
	...
	public static Predicate<Integer> mockPredicate1() {
		Predicate<Integer> mockInstance = mock(Predicate.class);
		when(mockInstance.evaluate(any())).thenAnswer((stubInvo) -> {
			Integer value = stubInvo.getArgument(0);
			return value % 2 == 1;
		});
		return mockInstance;
	}
	...
	public void createPredicatedCollectionWithPredicate() {
		final Predicate<Integer> p = PredicatedCollectionBuilderTest.mockPredicate1();
