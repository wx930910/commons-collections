...
/**
 * This class is used in TestCompositeMap. When testing serialization, the class
 * has to be separate of TestCompositeMap, else the test class also has to be
 * serialized.
 */
class EmptyMapMutator<K, V> implements CompositeMap.MapMutator<K, V> {
	...
	@Override
	public void resolveCollision(final CompositeMap<K, V> composite, final Map<K, V> existing, final Map<K, V> added,
