...
public class SetUniqueListTest<E> extends AbstractListTest<E> {
	...
	public SetUniqueList<E> mockSetUniqueList1(final List<E> list, final Set<E> set) {
		long mockFieldVariableSerialVersionUID = 1415013031022962158L;
		SetUniqueList<E> mockInstance = spy(new SetUniqueList(list, set));
		return mockInstance;
	}
	...
	public E[] getFullNonNullElements() {
		...
		return (E[]) new Object[] { "", "One", Integer.valueOf(2), "Three", Integer.valueOf(4), new Double(5),
				new Float(6), "Seven", "Eight", "Nine", Integer.valueOf(10), new Short((short) 11), new Long(12),
	...
	public void testCollections307() {
		...
		list = new ArrayList<>();
		uniqueList = mockSetUniqueList1(list, new java.util.TreeSet<E>());
	...
	public void testSetDownwardsInList() {
		/*
		 * Checks the following semantics [a,b] set(0,b): [b]->a So UniqList contains
		 * [b] and a is returned
		 */
